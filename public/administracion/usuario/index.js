...
jQuery(document).ready(function($) 
{
	...
	formCreate.submit(function(event) {
		...
		{
			$.ajax({
				url: site_url('/administracion/usuario/createAjax'),
				type: 'POST',
				dataType: 'json',
	...
	$(document).on('click', ".btnEditar", function()
	{
	  ...
	  $.ajax({
	    url: site_url("/administracion/usuario/getUsuarioAjax"),
	    type: 'POST',
	    dataType: 'json',
	...
	formEdit.submit(function(event) {
		...
		{
			$.ajax({
				url: site_url('/administracion/usuario/editAjax'),
				type: 'POST',
				dataType: 'json',
	...
	$(document).on('click', ".btnEliminar", function()
	{
	  ...
	  $.confirmCI( '', function(result){
	    ...
	    {
	      $.ajax({
	        url: site_url("/administracion/usuario/deleteUsuarioAjax"),
	        type: 'POST',
	        dataType: 'json',
	        data: {"usuario[id_usuario]": id_usuario},
	      })
...
function loadListUsuarios(dataForm)
{
	...
	$.ajax({
		url: site_url('/administracion/usuario/listaAjax'),
		type: 'POST',
		dataType: 'json',
		data: dataForm
	})
