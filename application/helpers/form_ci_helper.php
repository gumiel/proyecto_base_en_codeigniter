...
if ( ! function_exists('form_open_ci'))
{
	/**
	 * Form Declaration
	 *
	 ...
	 * @return	string
	 */
	function form_open_ci($action = '', $attributes = array(), $hidden = array())
	{
		$attributes = addClass($attributes, "form-horizontal");
...
if ( ! function_exists('form_open_multipart_ci'))
{
	/**
	 ...
	 * @return	string
	 */
	function form_open_multipart_ci($action = '', $attributes = array(), $hidden = array())
	{
		...
		return form_open_ci($action, $attributes, $hidden);
	}
}
...
if ( ! function_exists('form_input_ci'))
{
	/**
	 * Text Input Field
	 *
	 ...
	 * @return	string
	 */
	function form_input_ci($label = '', $data = '', $value = '', $extra = '')
	{
		$extra = addClass( $extra, "form-control" );
		$defaults = array(
			'type' => 'text',
			'name' => is_array($data) ? '' : $data,
			'value' => $value
		);
		$input = '<input '._parse_form_attributes($data, $defaults)._attributes_to_string($extra)." />\n";		
		return addLabelInput($label, $input);
	}
}

// ------------------------------------------------------------------------

if ( ! function_exists('form_password_ci'))
{
	/**
	 * Password Field
	 *
	 ...
	 * @return	string
	 */
	function form_password_ci($label = '', $data = '', $value = '', $extra = '')
	{		
		is_array($data) OR $data = array('name' => $data);
		$data['type'] = 'password';
		return form_input_ci($label, $data, $value, $extra);
	}
}

// ------------------------------------------------------------------------

if ( ! function_exists('form_upload_ci'))
{
	/**
	 * Upload Field
	 *
	 ...
	 * @return	string
	 */
	function form_upload_ci($label = '', $data = '', $value = '', $extra = '')
	{
...
if ( ! function_exists('form_textarea_ci'))
{
	/**
	 * Textarea field
	 *
	 ...
	 * @return	string
	 */
	function form_textarea_ci($label = '', $data = '', $value = '', $extra = '')
	{
		$extra = addClass($extra, "form-control");
		$defaults = array(
			'name' => is_array($data) ? '' : $data,
		...
		$textArea = '<textarea '._parse_form_attributes($data, $defaults)._attributes_to_string($extra).'>'
			.html_escape($val)
			."</textarea>\n";
		return addLabelInput($label, $textArea);
	}
}
...
if ( ! function_exists('form_dropdown_ci'))
{
	/**
	 * Drop-down Menu
	 *
	 ...
	 * @return	string
	 */
	function form_dropdown_ci($label = '', $data = '', $options = array(), $selected = array(), $extra = '')
	{
		$extra = addClass($extra, "form-control");
		$defaults = array();
		...
		$dropDown = addLabelInput($label, $form."</select>\n");
