<?php 
// echo "string";
$config['pages_public']         = [ "/nucleo/nuc_publico/login", "/nucleo/nuc_publico/payment", "/nucleo/nuc_publico/crearCaptcha"];
$config['default_page_private'] = [ "/nucleo/nuc_publico/login" ];
...
$config['default_page_private'] = "/nucleo/nuc_usuario/lista";
